# 18439번(LCS 6) 문제 : https://www.acmicpc.net/problem/18439
# LCS6은 따로 업로드 하지 않습니다. LCS7(18440.py)에서 출력 형식만 변경하면 LCS 6 정답입니다.
# 대신 LCS 8 소스 코드를 공유할게요!
# 20027번(LCS 8) 문제 : https://www.acmicpc.net/problem/20027
import sys

input = sys.stdin.readline

# 참고 소스 코드는 hijkl2e님 C++ 소스 코드를 참고했습니다.
